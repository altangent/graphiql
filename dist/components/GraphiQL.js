...
var _SidebarTabItem = require('./SidebarTabItem');
    ...
    _this.state = _extends(
      {
        ...
        subscription: null,
        selectedTabOption: Number(_this._storage.get('selectedTabOption')) || 0,
      },
      queryFacts,
    );
  ...
  _createClass(GraphiQL, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var tabs = [
          _react2.default.createElement(_DocExplorer.DocExplorer, {
            key: 'docExplorer',
            ref: function ref(c) {
        ...
        var sidebarAdditions =
          (0, _find2.default)(children, function(child) {
            return child.type === GraphiQL.Sidebar;
          }) || null;
        // Array
        if (sidebarAdditions && sidebarAdditions.props.children.length) {
          ...
          try {
            for (
              var _iterator = sidebarAdditions.props.children[
                Symbol.iterator
              ](),
                _step;
          ...
          // Object
          var _newTab = _react2.default.cloneElement(
            sidebarAdditions.props.children,
            {
              ...
              tabs.map(function(t, i) {
                return _react2.default.createElement(
                  'div',
                  {
                    ...
                    className:
                      'tab-item ' +
                        (_this3.state.selectedTabOption === i ? 'active' : ''),
                    onClick: function onClick() {
                      return _this3.handleChangeTab(i);
                    },
                  },
                  _react2.default.createElement(
                    'a',
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleClickReference = function(reference) {
    _this6.handleChangeTab(0).then(function() {
  ...
  this.handleChangeTab = function(indx) {
    _this6._storage.set('selectedTabOption', indx);
    return new Promise(function(resolve) {
      _this6.setState({ selectedTabOption: indx }, resolve);
    });
  };
...
// Add sidebar tabs
GraphiQL.Sidebar = _Sidebar.Sidebar;
GraphiQL.SidebarTabItem = _SidebarTabItem.SidebarTabItem;
